...
In order to meet the requirements explained section~\ref{sec:requirements}, 
...
As stated section~\ref{sec:requirements}, we target compatibility will the main open-source clinical research platforms. 
...
% keep for obj. 2
%\subsubsection{Privacy-Preserving Platform}
%medco  here, the only one basically (check refs paper)
...
Now that we chose the fundamental building blocks of our solutions, there are two main approaches we can use to assemble them together.
