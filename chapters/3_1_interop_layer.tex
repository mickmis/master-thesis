...
Using this authentication mechanism, the back end systems have a stateless authentication that needs only the Keycloak signing keys, the client identifier and the self-contained token.
